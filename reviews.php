...
<style>
    ...
    .movie-box:hover {
        ...
        background-image: linear-gradient(to right, #FFD700, #FF6347); /* Adjust the colors as needed */
        color: #fff; /* Updated text color on hover */
    }  

    .movie-name {
        margin-bottom: 10px;
        transition: color 0.3s ease-in-out; /* Added color transition for .movie-name */
        color: #eee;
    }
    ...
    .review-column {
        padding: 10px;
        flex: 3; /* Adjust the flex value to make it longer */
    }
