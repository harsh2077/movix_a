...
// Example: Set $session_id from the session variable
$session_id = $_SESSION['id'];

//retrieve user id
$user_id = $session_id;
//define the select statement
$query_str = "SELECT * FROM users where user_id = ". $user_id; // where user id s removed as it is not working properly 
...
$result_row = $result->fetch_assoc();  // this does not work as user id is not defined in query str 
	...
	<div class="container wrapper">
		...
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2">
				<h1 class="text-center text-success">Hi <?php 
				// echo $user_id;
				// echo $_SESSION['id'];
				// echo $session_id;
