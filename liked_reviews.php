...
<style>
    ...
    .panel-heading a {
        ...
        font-weight: bold;
        transition: color 0.3s ease-in-out; /* Transition color on hover */
    }
    ...
    .panel-body {
        ...
        transition: background-color 0.3s ease-in-out; /* Transition background color on hover */
    }

    .panel:hover .panel-body {
        background-color: #3c2f58; /* Lighter background color on hover */
    }
